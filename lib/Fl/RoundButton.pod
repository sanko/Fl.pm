...
MODULE = Fl::RoundButton        PACKAGE = Fl::RoundButton         PREFIX = Fl_
...
Fl_Round_Button::new( ... )
    CASE: (items == 5 || items == 6)
        CODE:
            ...
            RETVAL = new Fl_Round_Button(x,y,w,h,label);
        OUTPUT:
            RETVAL

void
Fl_Round_Button::DESTROY()
    CODE:
...
BOOT:
    set_isa("Fl::RoundButton", "Fl::Button");
