...
Fl::RadioButton - Button with a Radio Circle that Turns Siblings Off
...
The Fl::RadioButton class represents a button that turns on a round light
...
=for markdown [http://www.fltk.org/doc-1.3/Fl_Round_Button.png]
...
Fl::RadioButton inherits from Fl::RoundButton which in turns inherits from
...
MODULE = Fl::RadioButton        PACKAGE = Fl::RadioButton         PREFIX = Fl_
...
BOOT:
    set_isa("Fl::RadioButton", "Fl::RoundButton");
