...
Fl::Scrollbar inherits from Fl::Slider, Fl::Valuator and Fl::Widget. On top of
...
Sets the position (first line displayed), size (number of lines displayed), and
range of the slider in the scrollbar (number of first and total lines).
